<x-layout>
    ...
    <div class="container" style="padding: 5%">
        <h2><b>The Ramadan Project</b></h2>
        <p style="margin-top: 3%">       
            As the foundation always has focus on the needy, they never forget to do it in the holy month of Ramadan too.
            Food, Water has been distributing amongst the people to break their fasting for the last couple of years. In the month of Sacrifice, the volunteers always had tried their best to serve the peoples.
            At the holy festival called ‘Eid-ul-Fitre’ we have provided cloths, food items, toys to the kids and their family so that they can celebrate the festivals too. We have a believe that, the flag of no discrimination will fly one day by the hand of our next generation and who knows kids from our school maybe will take the lead for the revolution.
        </p>
    </div>
